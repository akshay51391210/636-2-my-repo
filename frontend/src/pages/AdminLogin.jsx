  ...
  const submit = async (e) => {
    ...
    try {
      ...
      if (res.data?.token) {
        ...
        // ensure role=admin in client context
        const user = { ...(me?.data || {}), role: "admin" };
        login(user);
  ...
  return (
    ...
    >
      ...
      <div
        ...
        style={{ backgroundColor: "#9DB4E5", width: 560, minHeight: 480 }}
      >
        <h1
        ...
        <form className="flex flex-col gap-4" onSubmit={submit}>
          ...
          <div>
            ...
            <input
              ...
              required
              disabled={loading}
              placeholder="Enter admin secure code"
      ...
      <p className="mt-4 text-sm relative z-10">Use your admin email, password and secure code.</p>
    </div>
  );
}
