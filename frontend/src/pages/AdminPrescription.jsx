...
export default function AdminPrescription() {
  ...
  const [formData, setFormData] = useState({
    ...
    medication: {
      ...
      doseEachTime: "",       // e.g., 1 tablet / 5 mL
      frequency: "",          // e.g., twice daily
      route: "",              // e.g., Oral / Topical / Eye / Ear
  ...
  const startEdit = (row) => {
    ...
    setFormData({
      ...
      date: row.date || "",
      time: row.time || "",
      symptomsDiagnosis: row.symptomsDiagnosis || row.reason || "", // fallback if backend still uses "reason"
      weight: row.weight || "",
  ...
  return (
    <div className="page-shell">
      <style>{`
        /* Page spacing and center container */
        .page-shell { padding: 28px 20px; }
        .container { max-width: 1120px; margin: 0 auto; }

        /* Cards + compact sizing (about ~30% smaller than default) */
      ...
      <div className="container">
        ...
        <p className="page-sub">Create and manage prescriptions.</p>
